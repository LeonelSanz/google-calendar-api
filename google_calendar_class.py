...
class GoogleCalendarManager:
    ...
    def update_event(self, event_id, summary=None, start_time=None, end_time=None):
        ...
        if start_time:
            event['start']['date_time'] = start_time.strftime('%Y-%m-%dT%H:%M:%S')
        
        if end_time:
            event['end']['date_time'] = end_time.strftime('%Y-%m-%dT%H:%M:%S')
...
# calendar.create_event("Hola probando", "2023-09-21T16:30:00+02:00","2023-09-21T17:30:00+02:00","Europe/Madrid")